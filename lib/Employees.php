...
class Employees{
	...
	function deleteValue($employee_id,$first_name,$last_name,$email,$phone_number,$hire_date,$job_id,$salary,$commission_pct,$manager_id,$department_id){
        // $this();
        $this->employee_id = $employee_id;
        $this->first_name = $first_name;
        $this->last_name = $last_name;
	...
	function create(){
        $count= count($this->getDataEmployees($this->employee_id));
        if ($count>0){
    ...
    function getAll(){
        ...
        return $data;
		 ...
		 function getDataEmployees($employee_id){
        // return "test";
